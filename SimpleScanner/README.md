...
```bash
git clone https://github.com/ReshXWorks/ICL_CyberSecurity/SimpleScanner.git
cd SimpleScanner
...
```bash
python simplescanner.py -u http://example.com -w wordlist.txt
```
...
```bash
python simplescanner.py -u http://example.com -w wordlist.txt -s 200,403
```

### 2. Use more threads for faster scanning

```bash
python simplescanner.py -u http://example.com -w wordlist.txt -t 30
```

### 3. Enable file extension fuzzing

```bash
python simplescanner.py -u http://example.com -w wordlist.txt -e .php,.html,.txt,
```

### 4. Save results to a file

```bash
python simplescanner.py -u http://example.com -w wordlist.txt -o results.txt
```

### 5. Full featured scan

```bash
python simplescanner.py -u http://example.com -w wordlist.txt -t 20 -s 200,403 -e .php,.html,.txt, -o results.txt
```
